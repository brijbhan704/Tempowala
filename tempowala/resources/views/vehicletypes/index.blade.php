...
<script>
          ...
          table = jQuery('#eventsData').DataTable({
            ...
            },
            {
                ...
                action: function ( e, dt, node, config ) {
                  ...
                  location.href="{{url('/')}}/vehicletypes/add";
                }
            }
            ],
            ...
            'ajax': {
              'url': '{{ url("/") }}/vehicletypes/vehicleTypeIndexAjax',
              'headers': {
        ...
        function editpage(id){
          window.location.href = "{{url('/')}}/vehicletypes/edit/"+id
        }
        

        function deleteRow(id){
          if(confirm('Are you sure want to delete record?')){
            window.location.href = "{{url('/')}}/vehicletypes/destroy/"+id;
          }
        }
